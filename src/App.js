...
import ProductData from './ProductDate';
      ...
      <div className="App">
       <Nav count={this.state.cartCount} /> {/* Navbar  */}
        <header className="bg-dark py-5">
          <div className="container px-4 px-lg-5 my-5">
            <div className="text-center text-white">
              <h1 className="display-4 fw-bolder">Niro Shop in style</h1>
        ...
        <footer className="py-5 bg-dark">
          <div className="container"><p className="m-0 text-center text-white">Copyright © Nirmala 2023</p></div>
        </footer>
      </div>
    );
  }
